...
pjnz <- system.file("~/Documents/Data/Spectrum files/2018 final/SSA", "DRC_2018_final_v5_65.PJNZ", package="eppasm")
...
sim_2020 <- data.frame(rbinom(100, 3000, outputs_new[["prevalence"]]["2020"])/3000)
...
for (i in 1:3) {
  ...
  prop_75 %<>%
    rbind(data.frame("prop_above_75" = sum(inc_red$incidence_red >= 0.75)/3000))
}
